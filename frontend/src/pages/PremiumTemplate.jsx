...
const PremiumTemplate = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-600 to-teal-900 text-white flex flex-col items-center">
      ...
      <header id="section1" className="bg-teal-800 w-full p-4 shadow-md">
        <h1 className="text-4xl font-bold text-center reveal-from-right">Preview Mode</h1>
      </header>
      <main className="flex-1 w-full p-4">
        <section className="bg-teal-700 p-8 shadow-md rounded-lg max-w-3xl mx-auto mb-8 text-center reveal-from-right"
        ...
        <section id="section2" className="bg-teal-700 p-8 shadow-md rounded-lg max-w-3xl mx-auto mb-8 text-center reveal-from-left"
        ...
        <section id="section3" className="bg-teal-700 p-8 shadow-md rounded-lg max-w-3xl mx-auto mb-8 text-center reveal-from-right"
