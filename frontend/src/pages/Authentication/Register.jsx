    ...
    <div className="w-full md:w-1/2 p-6 md:p-8 lg:p-10 rounded-lg md:rounded-l-lg md:rounded-r-lg">
        <form className="my-2 space-y-4" onSubmit={handleRegister}>
            ...
            <div className="flex items-center border rounded-lg">
                    ...
                    <input id="username" name="username" type="text" required className="flex-1 p-2.5 text-sm text-gray-900 border-none focus:ring-blue-500 focus:border-blue-500 rounded-r-lg" placeholder="Username" 
                ...
                <div className="flex items-center border rounded-lg">
                    ...
                    <input id="email" name="email" type="email" autoComplete="email" required className="flex-1 p-2.5 text-sm text-gray-900 border-none focus:ring-blue-500 focus:border-blue-500 rounded-r-lg" placeholder="Email" 
                ...
                <div className="flex items-center border rounded-lg">
                    ...
                    <input id="password" name="password" type="password" autoComplete="current-password" required className="flex-1 p-2.5 text-sm text-gray-900 border-none focus:ring-blue-500 focus:border-blue-500 rounded-r-lg" placeholder="Password" 
                ...
                <div className="flex items-center border rounded-lg">
                    ...
                    <input id="phone" name="phone" type="number" required className="flex-1 p-2.5 text-sm text-gray-900 border-none focus:ring-blue-500 focus:border-blue-500 rounded-r-lg" placeholder="No-Telp" 
                ...
                <div className="flex items-center border rounded-lg">
                    ...
                    <input id="address" name="address" type="text" required className="flex-1 p-2.5 text-sm text-gray-900 border-none focus:ring-blue-500 focus:border-blue-500 rounded-r-lg" placeholder="Alamat" 
            ...
            <div className="text-center pt-4">
                <button type="button" className="text-sm font-medium text-indigo-600 hover:text-indigo-500" ><Link to="/login">Kembali ke login</Link></button>
            </div>
        </form>
    </div>
</div>
